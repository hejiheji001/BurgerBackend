...
{
    private const string BROKER_NAME = "burger_event_bus";
    private const string AUTOFAC_SCOPE_NAME = "burger_event_bus";
    ...
    public string GetGenericTypeName(object @object)
    {
